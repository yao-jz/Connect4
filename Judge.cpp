...
bool userWin1(const int x, const int y, const int M, const int N, int* const board){
	//横向检测
    int i, j;
    int count = 0;
    for (i = y; i >= 0; i--)
...
bool machineWin1(const int x, const int y, const int M, const int N, int* const board){
	//横向检测
    int i, j;
    int count = 0;
    for (i = y; i >= 0; i--)
